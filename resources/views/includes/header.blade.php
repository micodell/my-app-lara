<nav id="header" class="bg-white bg-opacity-0 transition-all duration-500 ease-in-out text-slate-300 p-4 h-20 flex items-center sticky top-0 z-50">
...
<script>
    ...
    window.addEventListener('scroll', ()=> {
        if (window.scrollY > 0) {
            ...
            header.classList.add('backdrop-blur-lg', 'shadow-md', 'bg-opacity-5');
        } else {
            header.classList.add('bg-opacity-0');
            header.classList.remove('backdrop-blur-lg', 'shadow-md', 'bg-opacity-5');
        }
    })
</script>
